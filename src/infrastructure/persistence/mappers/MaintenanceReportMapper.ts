...
export class MaintenanceReportMapper {
    public static toDomain(entity: MaintenanceReportEntity): MaintenanceReport {
        return new MaintenanceReport({
            ...
            costoEstimado: (entity.costoEstimado !== null && entity.costoEstimado !== undefined) ? Number(entity.costoEstimado) : undefined,
            costoFinal: (entity.costoFinal !== null && entity.costoFinal !== undefined) ? Number(entity.costoFinal) : undefined,
